  ...
  void _startInitialTimer() {
    ...
    _timer1 = Timer.periodic(Duration(seconds: 1), (timer) {
      if (_timeInSeconds1 == 0) {
        ...
        if (_timeInSeconds1 < 1) {
          play0sek();
        } else if (_timeInSeconds1 <= 5) {
          play5sek();
        }
      }
    });
    setState(() {
      ...
      _isTimerRunning =
          false; // Останавливаем основной таймер, если он был запущен
    });
  }
  ...
  void _startTimer() {
    ...
    if (!_isTimerRunning) {
      ...
      setState(() {
        ...
        _isTimerRunning1 =
            false; // Останавливаем таймер отсчета, если он был запущен
      });
    }
  }

  void play5sek() async {
    await audioPlayer.setAsset('assets/sound/blip.mp3');
    await audioPlayer.play();
  }

  void play0sek() async {
    await audioPlayer.setAsset('assets/sound/round.mp3');
    await audioPlayer.play();
  }
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            onChanged: (String value) {
                              setState(() {
                                day.titleday = titleController.text;
                                  ...
                                  onChanged: (double value) {
                                    setState(() {
                                      ...
                                      weightController12.text =
                                          _currentWeight.toStringAsFixed(1);
                                      day.weight12 = weightController12.text;
                                    });
                                  },
                                ),
                              ),
